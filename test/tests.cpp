...
TEST(WORDS, ASCII_TEXT) {
    ...
    input << data;
    uint64_t result = WordsMode::process(input, "text", false);
    ASSERT_EQ(result, 3);
    input.clear();
    input << data;
    result = WordsMode::process(input, "th", false);
    ASSERT_EQ(result, 1);
    input.clear();
    input << data;
    result = WordsMode::process(input, "Th", false);
    ...
    input.clear();
    input << data;
    result = WordsMode::process(input, "Th", true);
    ASSERT_EQ(result, 3);
}
...
TEST(WORDS, UTF_TEXT) {
    ...
    input << data;
    uint64_t result = 0;
    result = WordsMode::process(input, "код", false);
    ASSERT_EQ(result, 2);
    input.clear();
    input << data;
    result = WordsMode::process(input, "is", false);
    ASSERT_EQ(result, 2);
    input.clear();
    input << data;
    result = WordsMode::process(input, "absent", false);
    ASSERT_EQ(result, 0);
}
...
TEST(WORDS, MANGLED) {
    ...
    uint64_t result = 0;
    result = WordsMode::process(input, "text", false);
    ASSERT_EQ(result, 1);
    input.clear();
